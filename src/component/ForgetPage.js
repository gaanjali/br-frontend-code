  ...
  return (
    ...
    <div class="bg-white  rounded-lg shadow-lg overflow-hidden  flex flex-col md:flex-row ">
        ...
        <div class=" md:w-1/2 p-8">
            ...
            <h4 class=" text-center mb-4 pb-1">FORGOT YOUR Password?</h4>
...
<Link to="/ResetPage"><button type="submit"class="bg-black text-white font-bold w-full py-2 mt-3 px-4 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50">CONTINUE</button></Link>
</div>
